...
*    SELECT SINGLE planetype, weight, tankcap FROM saplane
*                    INTO CORRESPONDING FIELDS OF @ls_planetype
...
* new() operator can't be used with old non class based exceptions
*  go_airplane = new #( iv_name = 'LH Berlin' iv_planetype = 'A321' ).
* in this case CREATE OBJECT has to be used
