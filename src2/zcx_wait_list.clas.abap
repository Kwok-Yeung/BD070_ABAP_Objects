class ZCX_WAIT_LIST definition
  public
...
*"* public components of class ZCX_WAIT_LIST
*"* do not include other source files here!!!
  interfaces IF_T100_MESSAGE .

  constants:
    begin of ZCX_WAIT_LIST,
...
protected section.
*"* protected components of class ZCX_WAIT_LIST
*"* do not include other source files here!!!
private section.
*"* private components of class ZCX_WAIT_LIST
*"* do not include other source files here!!!
ENDCLASS.



CLASS ZCX_WAIT_LIST IMPLEMENTATION.
...
if textid is initial.
  IF_T100_MESSAGE~T100KEY = ZCX_WAIT_LIST .
else.
