class ZCB_BD070_SAPLANE definition
  public
...
public section.
  ...
  methods CREATE_PERSISTENT
    ...
    returning
      value(RESULT) type ref to ZCL_BD070_SAPLANE
    raising
...
protected section.
  ...
  types TYP_OBJECT_REF type ref to ZCL_BD070_SAPLANE .
  types:
  ...
  types:
    begin of TYP_DB_DATA ,
      ...
      CONSUM type S_CONSUM ,
      CON_UNIT type S_CONUNIT ,
      TANKCAP type S_CAPACITY ,
      CAP_UNIT type S_CAPUNIT ,
      WEIGHT type S_PLAN_WEI ,
      WEI_UNIT type S_WEI_UNIT ,
      SPAN type S_SPAN ,
      SPAN_UNIT type S_UNIT ,
      LENG type S_LENGTH ,
      LENG_UNIT type S_UNIT ,
      OP_SPEED type S_SPEED ,
      SPEED_UNIT type S_UNIT ,
...
CLASS ZCB_BD070_SAPLANE IMPLEMENTATION.


  method CREATE_PERSISTENT.
***BUILD 093901
*      IMPORTING I_PLANETYPE TYPE S_PLANETYE
*      RETURNING RESULT TYPE REF TO ZCL_BD070_SAPLANE
************************************************************************
...
*< Generated from mapping:
  BUSINESS_KEY-PLANETYPE = I_PLANETYPE.
*>
...
*< Generated from mapping:
  call method GET_PERSISTENT
       exporting I_PLANETYPE = BUSINESS_KEY-PLANETYPE
...
*<Generated from mapping:
  E_BUSINESS_KEY-PLANETYPE  = I_DB_DATA-PLANETYPE.
*>
...
************************************************************************
  ...
  data: THE_OBJECT type ref to ZCL_BD070_SAPLANE,
...
*<  Generated from mapping:
    ...
    OBJECT_DATA_ITEM-CONSUM = THE_OBJECT->CONSUM.
    OBJECT_DATA_ITEM-CON_UNIT = THE_OBJECT->CON_UNIT.
    OBJECT_DATA_ITEM-TANKCAP = THE_OBJECT->TANKCAP.
    OBJECT_DATA_ITEM-CAP_UNIT = THE_OBJECT->CAP_UNIT.
    OBJECT_DATA_ITEM-WEIGHT = THE_OBJECT->WEIGHT.
    OBJECT_DATA_ITEM-WEI_UNIT = THE_OBJECT->WEI_UNIT.
    OBJECT_DATA_ITEM-SPAN = THE_OBJECT->SPAN.
    OBJECT_DATA_ITEM-SPAN_UNIT = THE_OBJECT->SPAN_UNIT.
    OBJECT_DATA_ITEM-LENG = THE_OBJECT->LENG.
    OBJECT_DATA_ITEM-LENG_UNIT = THE_OBJECT->LENG_UNIT.
    OBJECT_DATA_ITEM-OP_SPEED = THE_OBJECT->OP_SPEED.
    OBJECT_DATA_ITEM-SPEED_UNIT = THE_OBJECT->SPEED_UNIT.
    OBJECT_DATA_ITEM-PRODUCER = THE_OBJECT->PRODUCER.
...
************************************************************************
  ...
  data: OBJECT_IREF type TYP_OBJECT_IREF,
        THE_OBJECT  type ref TO ZCL_BD070_SAPLANE.
...
*<    Generated from Mapping:
      clear: THE_OBJECT->PLANETYPE,
             ...
             THE_OBJECT->WEI_UNIT,
             THE_OBJECT->SPAN,
             THE_OBJECT->SPAN_UNIT,
             THE_OBJECT->LENG,
             THE_OBJECT->LENG_UNIT,
             THE_OBJECT->OP_SPEED,
             THE_OBJECT->SPEED_UNIT,
             THE_OBJECT->PRODUCER,
...
*< Generated from mapping:
  types: TYP_DB_DATA_LOCAL type SAPLANE.
*>
...
*< Generated from mapping:
  field-symbols: <FS_DB_SAPLANE> type SAPLANE.
*>
...
*< Generated from mapping:
  select * from SAPLANE
           ...
           where SAPLANE~PLANETYPE = I_BUSINESS_KEY_TAB-PLANETYPE.
*>
...
* * error handling
  if ( SY-SUBRC <> 0 ).
    ...
    raise exception type CX_OS_DB_SELECT
         exporting TABLE  = 'SAPLANE'
                   TEXTID = CX_OS_DB_SELECT=>BY_BKEYTAB.
  endif. "( Error )

  loop at DB_DATA_LOCAL_TAB assigning <FS_DB_DATA_LOCAL>.

    assign <FS_DB_DATA_LOCAL> to <FS_DB_SAPLANE>.

*< Generated from mapping:
    DB_DATA-PLANETYPE = <FS_DB_SAPLANE>-PLANETYPE.
    DB_DATA-SEATSMAX = <FS_DB_SAPLANE>-SEATSMAX.
    DB_DATA-CONSUM = <FS_DB_SAPLANE>-CONSUM.
    DB_DATA-CON_UNIT = <FS_DB_SAPLANE>-CON_UNIT.
    DB_DATA-TANKCAP = <FS_DB_SAPLANE>-TANKCAP.
    DB_DATA-CAP_UNIT = <FS_DB_SAPLANE>-CAP_UNIT.
    DB_DATA-WEIGHT = <FS_DB_SAPLANE>-WEIGHT.
    DB_DATA-WEI_UNIT = <FS_DB_SAPLANE>-WEI_UNIT.
    DB_DATA-SPAN = <FS_DB_SAPLANE>-SPAN.
    DB_DATA-SPAN_UNIT = <FS_DB_SAPLANE>-SPAN_UNIT.
    DB_DATA-LENG = <FS_DB_SAPLANE>-LENG.
    DB_DATA-LENG_UNIT = <FS_DB_SAPLANE>-LENG_UNIT.
    DB_DATA-OP_SPEED = <FS_DB_SAPLANE>-OP_SPEED.
    DB_DATA-SPEED_UNIT = <FS_DB_SAPLANE>-SPEED_UNIT.
    DB_DATA-PRODUCER = <FS_DB_SAPLANE>-PRODUCER.
    DB_DATA-SEATSMAX_B = <FS_DB_SAPLANE>-SEATSMAX_B.
    DB_DATA-SEATSMAX_F = <FS_DB_SAPLANE>-SEATSMAX_F.
*>
...
*<  Generated from mapping:
    <FS_OBJECT_DATA>-PLANETYPE = BUSINESS_KEY-PLANETYPE.
*>
...
* * SAPLANE: internal tables for mass operation
  data DB_ITB_SAPLANE type STANDARD TABLE OF SAPLANE.
  data DB_UTB_SAPLANE type STANDARD TABLE OF SAPLANE.
  data DB_DTB_SAPLANE type STANDARD TABLE OF SAPLANE.

* * SAPLANE: headlines for tables
  data DB_ILN_SAPLANE type SAPLANE.
  data DB_ULN_SAPLANE type SAPLANE.
  data DB_DLN_SAPLANE type SAPLANE.
...
*< Generated from mapping:
   ...
   DB_ILN_SAPLANE-SEATSMAX = <FS_INSERT>-SEATSMAX.
   DB_ILN_SAPLANE-CONSUM = <FS_INSERT>-CONSUM.
   DB_ILN_SAPLANE-CON_UNIT = <FS_INSERT>-CON_UNIT.
   DB_ILN_SAPLANE-TANKCAP = <FS_INSERT>-TANKCAP.
   DB_ILN_SAPLANE-CAP_UNIT = <FS_INSERT>-CAP_UNIT.
   DB_ILN_SAPLANE-WEIGHT = <FS_INSERT>-WEIGHT.
   DB_ILN_SAPLANE-WEI_UNIT = <FS_INSERT>-WEI_UNIT.
   DB_ILN_SAPLANE-SPAN = <FS_INSERT>-SPAN.
   DB_ILN_SAPLANE-SPAN_UNIT = <FS_INSERT>-SPAN_UNIT.
   DB_ILN_SAPLANE-LENG = <FS_INSERT>-LENG.
   DB_ILN_SAPLANE-LENG_UNIT = <FS_INSERT>-LENG_UNIT.
   DB_ILN_SAPLANE-OP_SPEED = <FS_INSERT>-OP_SPEED.
   DB_ILN_SAPLANE-SPEED_UNIT = <FS_INSERT>-SPEED_UNIT.
   DB_ILN_SAPLANE-PRODUCER = <FS_INSERT>-PRODUCER.
   DB_ILN_SAPLANE-SEATSMAX_B = <FS_INSERT>-SEATSMAX_B.
   DB_ILN_SAPLANE-SEATSMAX_F = <FS_INSERT>-SEATSMAX_F.


   DB_ILN_SAPLANE-PLANETYPE = <FS_INSERT>-PLANETYPE.
   append DB_ILN_SAPLANE to DB_ITB_SAPLANE.
*>
...
*< Generated from mapping:
   ...
   DB_ULN_SAPLANE-SEATSMAX = <FS_UPDATE>-SEATSMAX.
   DB_ULN_SAPLANE-CONSUM = <FS_UPDATE>-CONSUM.
   DB_ULN_SAPLANE-CON_UNIT = <FS_UPDATE>-CON_UNIT.
   DB_ULN_SAPLANE-TANKCAP = <FS_UPDATE>-TANKCAP.
   DB_ULN_SAPLANE-CAP_UNIT = <FS_UPDATE>-CAP_UNIT.
   DB_ULN_SAPLANE-WEIGHT = <FS_UPDATE>-WEIGHT.
   DB_ULN_SAPLANE-WEI_UNIT = <FS_UPDATE>-WEI_UNIT.
   DB_ULN_SAPLANE-SPAN = <FS_UPDATE>-SPAN.
   DB_ULN_SAPLANE-SPAN_UNIT = <FS_UPDATE>-SPAN_UNIT.
   DB_ULN_SAPLANE-LENG = <FS_UPDATE>-LENG.
   DB_ULN_SAPLANE-LENG_UNIT = <FS_UPDATE>-LENG_UNIT.
   DB_ULN_SAPLANE-OP_SPEED = <FS_UPDATE>-OP_SPEED.
   DB_ULN_SAPLANE-SPEED_UNIT = <FS_UPDATE>-SPEED_UNIT.
   DB_ULN_SAPLANE-PRODUCER = <FS_UPDATE>-PRODUCER.
   DB_ULN_SAPLANE-SEATSMAX_B = <FS_UPDATE>-SEATSMAX_B.
   DB_ULN_SAPLANE-SEATSMAX_F = <FS_UPDATE>-SEATSMAX_F.


   DB_ULN_SAPLANE-PLANETYPE = <FS_UPDATE>-PLANETYPE.
   append DB_ULN_SAPLANE TO DB_UTB_SAPLANE.
*>
...
* * Collect Deletes
  loop at I_DELETES assigning <FS_DELETE>.
    ...
    DB_DLN_SAPLANE-PLANETYPE = <FS_DELETE>-BUSINESS_KEY-PLANETYPE.

    append DB_DLN_SAPLANE TO DB_DTB_SAPLANE.
...
* * DB Deletes
  delete SAPLANE FROM TABLE DB_DTB_SAPLANE.
  if SY-SUBRC <> 0.
...
* * DB Inserts
  insert SAPLANE FROM TABLE DB_ITB_SAPLANE
...
* * DB Updates
  update SAPLANE FROM TABLE DB_UTB_SAPLANE.
  if SY-SUBRC <> 0.
...
*< Generated from mapping:
  COMP_STRING = I_BUSINESS_KEY-PLANETYPE.
...
*<  Generated from mapping:
  ...
  THE_OBJECT->CONSUM = I_OBJECT_DATA-CONSUM.
  THE_OBJECT->CON_UNIT = I_OBJECT_DATA-CON_UNIT.
  THE_OBJECT->TANKCAP = I_OBJECT_DATA-TANKCAP.
  THE_OBJECT->CAP_UNIT = I_OBJECT_DATA-CAP_UNIT.
  THE_OBJECT->WEIGHT = I_OBJECT_DATA-WEIGHT.
  THE_OBJECT->WEI_UNIT = I_OBJECT_DATA-WEI_UNIT.
  THE_OBJECT->SPAN = I_OBJECT_DATA-SPAN.
  THE_OBJECT->SPAN_UNIT = I_OBJECT_DATA-SPAN_UNIT.
  THE_OBJECT->LENG = I_OBJECT_DATA-LENG.
  THE_OBJECT->LENG_UNIT = I_OBJECT_DATA-LENG_UNIT.
  THE_OBJECT->OP_SPEED = I_OBJECT_DATA-OP_SPEED.
  THE_OBJECT->SPEED_UNIT = I_OBJECT_DATA-SPEED_UNIT.
  THE_OBJECT->PRODUCER = I_OBJECT_DATA-PRODUCER.
...
************************************************************************
  ...
  data: NEW_OBJECT type ref to ZCL_BD070_SAPLANE.

* * 1. Create object and set BKey attributes
  create object NEW_OBJECT.

* < Generated from mapping:
  NEW_OBJECT->PLANETYPE = I_BUSINESS_KEY-PLANETYPE.
* >
